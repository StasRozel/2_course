...
namespace In
{
	...
	struct IN
	{
        ...
        int code[256] =
        {
          ...
          IN::T, IN::F, IN::T, IN::T, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, // 48-63
          IN::F, '-', IN::F, IN::F, IN::F, IN::T, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::T, IN::F, IN::F, IN::T, // 64-79
          IN::F, IN::F, IN::T, IN::F, IN::F, IN::F, IN::F, IN::F, IN::I, IN::F, IN::T, IN::F, IN::F, IN::F, IN::F, IN::F, // 80-95
