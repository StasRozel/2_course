...
namespace лаба__10
{
    partial class Product
    {
     ...
     partial class Product
     {
        ...
        public Product(string NameProduct = "", string NameProducer = "", int Upc = 0, int Price = 0, string ShelfLife = "", int Amount = 0)
        {
            name = NameProduct;
        ...
        {
            return $"Name: {name} Producer: {producer} UPC: {upc} Price: {price} Shelf life: {shelfLife} Amount: {amount}";
        }
